...
+
https://docs.netapp.com/us-en/cloud-manager-sync/concept-cloud-sync.html["En savoir plus sur la copie et la synchronisation BlueXP"^]
...
* https://docs.netapp.com/us-en/cloud-manager-sync/index.html["Documentation sur la copie et la synchronisation BlueXP"^]
