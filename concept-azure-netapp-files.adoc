...
https://bluexp.netapp.com/cloud-volumes-global-regions["Affichez les régions Azure prises en charge"^]
...
* link:https://bluexp.netapp.com/azure-netapp-files["Site web NetApp BlueXP : Azure NetApp Files"^]
* link:https://learn.microsoft.com/azure/azure-netapp-files/["Documentation Azure NetApp Files"^]
* link:https://docs.netapp.com/us-en/bluexp-copy-sync/index.html["Documentation sur la copie et la synchronisation BlueXP"^]
